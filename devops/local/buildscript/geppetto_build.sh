...
DESKTOPCODE='../../../application/client/desktop/sample26'
DESKTOPIMAGENAME='geppettotest/sample26-desktop:1.0'
...
helm install --name sample26-5080 ./helm
if [ $? -eq 0 ]; then
